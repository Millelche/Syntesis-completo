      ...
      <Layout theme="agency">
        <section className="pt-32 pb-20 min-h-screen flex items-center justify-center">
          <div className="text-center">
            ...
            <Link to="/agency" className="text-primary hover:underline">
              ← Back to Roster
            </Link>
          </div>
        </section>
            ...
            <div className="opacity-0 animate-fade-up stagger-2">
              ...
              <div className="mb-8 pb-8 border-b border-border/50">
                ...
                <div className="flex flex-wrap gap-2">
                  {artist.labels.map(label => (
                    <span 
                      key={label}
                      className="bg-secondary px-4 py-2 text-sm font-medium"
                    >
                      {label}
                    </span>
                  ))}
              ...
              <div className="bg-card border border-border/50 p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Input 
                      placeholder="Organization Page URL"
                      value={formData.promoterPage}
                      onChange={e => setFormData({...formData, promoterPage: e.target.value})}
                      maxLength={50}
                      className="bg-background border-border/50"
                    />
                    <Input 
                  ...
                  <Button 
                    type="submit" 
                    className="w-full bg-primary text-primary-foreground hover:bg-primary/90 uppercase tracking-widest py-6"
                  >
                    BOOK
                  </Button>
                </form>
